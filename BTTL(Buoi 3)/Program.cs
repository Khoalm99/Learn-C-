...
namespace BTTL
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                //ma can ho
                Console.WriteLine("Mã căn hộ: ");
                String maHo = Console.ReadLine();

                //Tên chủ hộ
                Console.WriteLine("Tên chủ hộ: ");
                String chuHo = Console.ReadLine();

                NhapLai:
                //Số nước cũ
                Console.WriteLine("Số nước cũ: ");
                String soNuocCu = Console.ReadLine();
                float old = float.Parse(soNuocCu);
                
                //Số nước mới
                Console.WriteLine("Số nước mới: ");
                String soNuocMoi = Console.ReadLine();
                float new = float.Parse(soNuocMoi);

                //Kiểm tra số nước mới < số cũ
                try ///các việc cần kiểm tra
                {
                    new <= old;
                ...
                {
                    Console.WriteLine("Vui lòng nhập lại, số nước không đ");
                    goto NhapLai; ///khi gặp lỗi quay trở lại vị trí NhapLieu 
